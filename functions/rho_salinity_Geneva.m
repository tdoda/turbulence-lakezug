...
% Sebastiano Piccolroaz: moved the evaluation of conductivity at 20°C to a
% new subroutine (used also for the analysis of the ucond signal) 
%***********************************************************************
...
[Cond20,~,~]=conductivity_20(Temp,Cond);
