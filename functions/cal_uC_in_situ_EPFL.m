...
T_calibrated = polyval(p, T_ref_prof);
...
A(idx_beta1) =  {['beta_1      = ', num2str(beta(1),'%8.2f')]};
A(idx_beta2) =  {['beta_2      = ', num2str(beta(2),'%8.2f')]};
A(idx_T0) =  {['T_0      = ', num2str(T_0,'%8.2f')]};
