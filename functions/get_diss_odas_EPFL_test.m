...
addParamValue(p, 'viscosity',   val_data);   % EPFL change
...
%    nu     = visc35(mean_T);  % EPFL change
     nu = p.Results.viscosity; % EPFL change
...
flag_poly=1;
            ...
            %%%% EPFL %%%%%
% % % %             pr1 = log10(K_95); % SEB remove polyfit!
            %%%% EPFL %%%%%
