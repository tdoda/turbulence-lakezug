function plot_comparison_withsh(BINNED,profID,filename,folder_main,folder_out,type)
...
if strcmp(type,'sh1')
    flag_sh=BINNEDplot.flag_S1;
    probe_sh=BINNEDplot.eps_S1;
    K_sh=BINNEDplot.KOsborn_S1;
else
    flag_sh=BINNEDplot.flag_S2;
    probe_sh=BINNEDplot.eps_S2;
    K_sh=BINNEDplot.KOsborn_S2;
end

idx_good1=find(BINNEDplot.flag_T1==1 & flag_sh==1);
idx_good2=find(BINNEDplot.flag_T2==1 & flag_sh==1);

figure
subplot(2,2,1)
loglog(probe_sh(:),BINNEDplot.eps_T1(:),'ob','MarkerSize',2); hold on
loglog(probe_sh(:),BINNEDplot.eps_T2(:),'or','MarkerSize',2);
loglog(probe_sh(idx_good1),BINNEDplot.eps_T1(idx_good1),'ob','MarkerFaceColor','b','MarkerSize',2); hold on
loglog(probe_sh(idx_good2),BINNEDplot.eps_T2(idx_good2),'or','MarkerFaceColor','r','MarkerSize',2);
...
nel_perr1 = sum(BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1) < 2.8 & BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1) >1/2.8);
nel_perr2 = sum(BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2) < 2.8 & BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2) >1/2.8);
nel_1ord1 = sum(BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1) < 10 & BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1) >0.1);
nel_1ord2 = sum(BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2) < 10 & BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2) >0.1);
nel_tot = sum(~isnan(probe_sh(:)));
...
[r1, p1] = corrcoef(log10(probe_sh(idx_good1)),log10(BINNEDplot.eps_T1(idx_good1)),'rows','complete');
[r2, p2] = corrcoef(log10(probe_sh(idx_good2)),log10(BINNEDplot.eps_T2(idx_good2)),'rows','complete');
if sum([size(r1)] - [1 1])==0
    r1(2,1)=NaN;
end
if sum([size(r2)] - [1 1])==0
    r2(2,1)=NaN;
end
...
subplot(2,2,2)
loglog(K_sh(:),BINNEDplot.KOsbornCox_T1(:),'ob','MarkerSize',2); hold on
loglog(K_sh(:),BINNEDplot.KOsbornCox_T2(:),'or','MarkerSize',2);
loglog(K_sh(idx_good1),BINNEDplot.KOsbornCox_T1(idx_good1),'ob','MarkerFaceColor','b','MarkerSize',2); hold on
loglog(K_sh(idx_good2),BINNEDplot.KOsbornCox_T2(idx_good2),'or','MarkerFaceColor','r','MarkerSize',2);
...
% count n element that differ more than a factor 2.8 (propagation error) and a factor 10
nel_perr1 = sum(BINNEDplot.KOsbornCox_T1(idx_good1)./K_sh(idx_good1) < 2.8 & BINNEDplot.KOsbornCox_T1(idx_good1)./K_sh(idx_good1) >1/2.8);
nel_perr2 = sum(BINNEDplot.KOsbornCox_T2(idx_good2)./K_sh(idx_good2) < 2.8 & BINNEDplot.KOsbornCox_T2(idx_good2)./K_sh(idx_good2) >1/2.8);
nel_1ord1 = sum(BINNEDplot.KOsbornCox_T1(idx_good1)./K_sh(idx_good1) < 10 & BINNEDplot.KOsbornCox_T1(idx_good1)./K_sh(idx_good1) >0.1);
nel_1ord2 = sum(BINNEDplot.KOsbornCox_T2(idx_good2)./K_sh(idx_good2) < 10 & BINNEDplot.KOsbornCox_T2(idx_good2)./K_sh(idx_good2) >0.1);
% some statistics
...
[r1, p1] = corrcoef(log10(K_sh(idx_good1)),log10(BINNEDplot.KOsbornCox_T1(idx_good1)),'rows','complete');
[r2, p2] = corrcoef(log10(K_sh(idx_good2)),log10(BINNEDplot.KOsbornCox_T2(idx_good2)),'rows','complete');
if sum([size(r1)] - [1 1])==0
    r1(2,1)=NaN;
end
if sum([size(r2)] - [1 1])==0
...
ax3=subplot(2,2,3);
clear points
points(:,1)=[probe_sh(idx_good1); probe_sh(idx_good2) ];
...
ax4=subplot(2,2,4);
% loglog(probe_sh(:),BINNEDplot.eps_T1(:)./probe_sh(:),'ob','MarkerSize',2); hold on
% loglog(probe_sh(:),BINNEDplot.eps_T2(:)./probe_sh(:),'or','MarkerSize',2);
% loglog(probe_sh(idx_good1),BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1),'ob','MarkerFaceColor','b','MarkerSize',2); hold on
% loglog(probe_sh(idx_good2),BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2),'or','MarkerFaceColor','r','MarkerSize',2);
clear points
points(:,1)=[probe_sh(idx_good1); probe_sh(idx_good2) ];
points(:,2)=[BINNEDplot.eps_T1(idx_good1)./probe_sh(idx_good1); BINNEDplot.eps_T2(idx_good2)./probe_sh(idx_good2) ];
idx=find(~isnan(points(:,1))); points=points(idx,:);
